  ...
  return (
    <footer className="bg-background border-t border-border mt-20">
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
        ...
        {/* Bottom Footer */}
        <div className="flex flex-col items-center gap-4 text-center sm:grid sm:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] sm:items-center sm:gap-6 sm:text-left">
          {/* Copyright */}
          <div className="flex items-center justify-center gap-2 sm:justify-self-start">
            ...
            <p className="text-muted-foreground text-xs">
              &copy; {currentYear} Open Source Leg
            </p>
          </div>
          ...
          {/* Social Links */}
          <div className="flex items-center justify-center gap-1 sm:justify-self-end">
