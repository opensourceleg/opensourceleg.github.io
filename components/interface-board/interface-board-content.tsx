...
const datasheetV100Href = "/electronics/interface-board/RPi_CM5_Interface_Board_v1.0.0_Datasheet.pdf";
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <section id="pcb-layout" className="space-y-6 pb-8 border-b border-black/10">
          <div className="space-y-6">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              <div className="space-y-1">
                <SectionHeading title="Interactive PCB layout" accent="light-blue" />
                <p className="text-sm text-gray-500">Click the board to explore connectors, features, and pinout callouts.</p>
              </div>
            </div>
          ...
          <details className="group" open>
            <summary className="flex flex-col gap-2 cursor-pointer list-none sm:flex-row sm:items-center sm:justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500 group-open:hidden">Input and output power specifications at a glance.</p>
              </div>
              <span className="inline-flex items-center gap-2 text-sm font-medium text-gray-700">
                <span className="text-xs uppercase tracking-wide text-gray-500 font-semibold">Expand</span>
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[var(--light-blue)]/20 border border-black/10 text-gray-900 transition-transform duration-200 group-open:rotate-180">v</span>
              </span>
            </summary>
            <div className="mt-6 rounded-3xl border border-black/10 bg-white p-6 shadow-xl">
              <div className="space-y-6">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    <caption className="sr-only">Input power connector specifications</caption>
                    <thead>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">*Do not use J7 or J8 USB-C ports for power input. These are for high speed data transfer only.</p>
                </div>
              </div>
            </div>
          </details>
          ...
          <details className="group" open>
            <summary className="flex flex-col gap-2 cursor-pointer list-none sm:flex-row sm:items-center sm:justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500 group-open:hidden">Connector map, bus details, and mating parts.</p>
              </div>
              <span className="inline-flex items-center gap-2 text-sm font-medium text-gray-700">
                <span className="text-xs uppercase tracking-wide text-gray-500 font-semibold">Expand</span>
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[var(--light-blue)]/20 border border-black/10 text-gray-900 transition-transform duration-200 group-open:rotate-180">v</span>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    <tr className="border-t border-black/10">
                      ...
                      <td className="px-3 py-2"><a href="https://www.digikey.com/en/products/detail/molex/5013300400/1531501" target="_blank" rel="noopener noreferrer" className="underline text-[var(--light-blue)]">5013300400</a></td>
                    </tr>
                    <tr className="border-t border-black/10">
                      ...
                      <td className="px-3 py-2"><a href="https://www.digikey.com/en/products/detail/molex/5013300800/1531505" target="_blank" rel="noopener noreferrer" className="underline text-[var(--light-blue)]">5013300800</a></td>
                    </tr>
                    <tr className="border-t border-black/10">
                    ...
                    <tr className="border-t border-black/10">
                      ...
                      <td className="px-3 py-2"><a href="https://www.digikey.com/en/products/detail/molex/5013300300/1531500" target="_blank" rel="noopener noreferrer" className="underline text-[var(--light-blue)]">5013300300</a></td>
                    </tr>
                    <tr className="border-t border-black/10">
                      ...
                      <td className="px-3 py-2"><a href="https://www.digikey.com/en/products/detail/jst-sales-america-inc/SHR-04V-S-B/759868" target="_blank" rel="noopener noreferrer" className="underline text-[var(--light-blue)]">SHR-04V-S-B</a></td>
                    </tr>
                    <tr className="border-t border-black/10">
                    ...
                    <tr className="border-t border-black/10">
                      ...
                      <td className="px-3 py-2"><a href="https://www.tti.com/content/ttiinc/en/apps/part-detail.html?partsNumber=501331-0207&mfgShortname=MOL&utm=PNC2024&utm_term=501331-0207&ad_source=1&gad_campaignid=20878198023&gbraid=0AAAAADvyBAYlpdIrj3_VoOWbBV_LyPuHd&gclid=Cj0KCQiA6sjKBhCSARIsAJvYcpMLo20pU-iWSczj1KusdGSWY9HvQXdKQFdEqWIc83ize24FGx2gIfYaAv39EALw_wcB" target="_blank" rel="noopener noreferrer" className="underline text-[var(--light-blue)]">501331-0207</a></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p className="text-sm text-gray-700">
                Note: Pins can be remapped using RPi Device Tree Overlays in <code className="px-2 py-1 rounded text-xs font-mono text-gray-900 bg-white border border-black/10">/boot/firmware/config.txt</code>. Mating part numbers are linked to component search pages for convenience. For more details, refer to this <Link href="https://github.com/raspberrypi/firmware/blob/master/boot/overlays/README" target="_blank" rel="noopener noreferrer" className="underline text-[var(--light-blue)] hover:text-[var(--light-green)]">link</Link>.
              </p>
            </div>
          </details>
        </section>
          ...
          <details className="group" open>
            <summary className="flex flex-col gap-2 cursor-pointer list-none sm:flex-row sm:items-center sm:justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500 group-open:hidden">Step-by-step bring-up instructions for first power-on.</p>
              </div>
              <span className="inline-flex items-center gap-2 text-sm font-medium text-gray-700">
                <span className="text-xs uppercase tracking-wide text-gray-500 font-semibold">Expand</span>
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[var(--light-blue)]/20 border border-black/10 text-gray-900 transition-transform duration-200 group-open:rotate-180">v</span>
            ...
            <div className="mt-6 max-w-3xl">
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-6 justify-items-center">
                <div className="bg-white border border-black rounded-2xl p-5 space-y-2 shadow-xl lg:col-span-2 w-full">
                  ...
                  <p className="text-sm text-gray-600">Jump the J3 header pins to put the CM5 into storage mode.</p>
                </div>
                <div className="bg-white border border-black rounded-2xl p-5 space-y-2 shadow-xl lg:col-span-2 w-full">
                  <p className="text-sm uppercase tracking-wide text-[var(--light-blue)] font-semibold">Step 2</p>
                  <p className="text-sm text-gray-600">Set up your host device (personal computer) and install <code className="px-1.5 py-0.5 rounded text-xs font-mono text-gray-900 bg-gray-100 border border-black/10">rpiboot</code> to detect the CM5 as a storage device by following these <Link href="https://www.raspberrypi.com/documentation/computers/compute_module.html#set-up-the-host-device" target="_blank" rel="noopener noreferrer" className="underline text-[var(--light-blue)] hover:text-[var(--light-green)]">instructions</Link>.</p>
                </div>
                <div className="bg-white border border-black rounded-2xl p-5 space-y-2 shadow-xl lg:col-span-2 w-full">
                  <p className="text-sm uppercase tracking-wide text-[var(--light-blue)] font-semibold">Step 3</p>
                  <p className="text-sm text-gray-600">Install the CM5 on the interface board and connect to the host device using USB J2.</p>
                </div>
                <div className="bg-white border border-black rounded-2xl p-5 space-y-2 shadow-xl lg:col-span-2 w-full">
                  <p className="text-sm uppercase tracking-wide text-[var(--light-blue)] font-semibold">Step 4</p>
                  <p className="text-sm text-gray-600">Run <code className="px-1.5 py-0.5 rounded text-xs font-mono text-gray-900 bg-gray-100 border border-black/10">rpiboot</code> following the <Link href="https://www.raspberrypi.com/documentation/computers/compute_module.html#set-up-the-host-device" target="_blank" rel="noopener noreferrer" className="underline text-[var(--light-blue)] hover:text-[var(--light-green)]">instructions</Link> and after a few seconds, the CM5 should be detected as a mass-storage device.</p>
                </div>
                <div className="bg-white border border-black rounded-2xl p-5 space-y-2 shadow-xl lg:col-span-2 w-full">
                  <p className="text-sm uppercase tracking-wide text-[var(--light-blue)] font-semibold">Step 5</p>
                  <p className="text-sm text-gray-600">Flash an operating system image using an imaging tool like <Link href="https://www.raspberrypi.com/software/" target="_blank" rel="noopener noreferrer" className="underline text-[var(--light-blue)] hover:text-[var(--light-green)]">Raspberry Pi Imager</Link>. We highly recommend using the <Link href="https://github.com/neurobionics/robot-ci" target="_blank" rel="noopener noreferrer" className="underline text-[var(--light-blue)] hover:text-[var(--light-green)]">Robot-CI</Link> image by the Neurobionics Lab that auto-configures the peripheral ports to function with the interface board. Follow the repository instructions and enable the "Are you using the Neurobionics Interface Board" option when generating the image.</p>
                </div>
              </div>
            </div>
          </details>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-t border-black/10">
                    ...
                    <td className="px-3 py-2">
                      <Button
                        href="/electronics/interface-board/RPi_CM5_Interface_Board_v1.0.0_Datasheet.pdf"
                        download="RPi_CM5_Interface_Board_v1.0.0_Datasheet.pdf"
                        className="bg-[var(--light-green)] text-black border border-black hover:bg-[var(--light-blue)] hover:text-black"
                      >
                        Download
                        <ArrowUpRight className="w-4 h-4 ml-2" />
