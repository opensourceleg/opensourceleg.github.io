...
describe('Footer Component', () => {
  ...
  describe('Logo and Copyright Section', () => {
    ...
    it('renders the U-M Robotics logo in the footer center area', () => {
      render(<Footer />)

      const umLogo = screen.getByRole('img', { name: 'U-M Robotics' })
      expect(umLogo).toHaveAttribute('src', '/logo/um.png')
      expect(umLogo).toHaveAttribute('width', '132')
      expect(umLogo).toHaveAttribute('height', '22')
      expect(umLogo).toHaveClass('h-auto', 'w-24', 'sm:w-32')
    })
  })
  ...
  describe('Responsive Layout', () => {
    ...
    it('applies responsive spacing classes', () => {
      ...
      const bottomSection = container.querySelector('.flex.flex-col.items-center.gap-4.text-center.sm\\:grid')
  ...
  describe('Layout Structure', () => {
    ...
    it('positions copyright and social links correctly', () => {
      ...
      const bottomSection = container.querySelector('.flex.flex-col.items-center.gap-4.text-center.sm\\:grid.sm\\:grid-cols-\\[minmax\\(0\\,1fr\\)_auto_minmax\\(0\\,1fr\\)\\].sm\\:items-center.sm\\:gap-6.sm\\:text-left')
      expect(bottomSection).toBeInTheDocument()
    })
    ...
    it('groups social links correctly', () => {
      ...
      const socialSection = container.querySelector('.flex.items-center.justify-center.gap-1.sm\\:justify-self-end')
    ...
    it('keeps the U-M Robotics logo centered between the brand and social groups', () => {
      const { container } = render(<Footer />)

      const bottomSection = container.querySelector('.flex.flex-col.items-center.gap-4.text-center.sm\\:grid')
      const umLogo = screen.getByRole('img', { name: 'U-M Robotics' })

      expect(bottomSection?.children[1]).toContainElement(umLogo)
    })
  })
  ...
  describe('Accessibility', () => {
    ...
    it('provides alt text for the U-M Robotics logo', () => {
      render(<Footer />)

      const umLogo = screen.getByRole('img', { name: 'U-M Robotics' })
      expect(umLogo).toHaveAttribute('alt', 'U-M Robotics')
    })
  })
}) 
